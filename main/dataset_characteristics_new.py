...
for Mashup in Mashups:
    ...
    Mashup_categories.append(Mashup["Categories"][0])
...
for API in APIs:
    ...
    API_categories.append(API["Primary Category"])
...
for Mashup in Mashups:
    MemberAPIs = Mashup["Related APIs"]
    Flag = 0
...
sparsity = 1 - Number_of_interactions / (
            Number_of_Mashups_with_included_APIs * Number_of_called_APIs)  # Mashup-API矩阵的稀疏度
