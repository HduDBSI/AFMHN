...
from deepctr_torch.models import basicFM, DeepFM, AFM, NAFM, xDeepFM, AutoInt, xDeepAFM
...
if __name__ == "__main__":
    ...
    data = pd.read_csv('../result/input_data_new.csv')
    ...
    [dnn_hidden_units, attention_factor, cin_layer_size, l2_reg, dropout, batch_size] = [128, 16, 2, 0.01, 0.5, 64]
    ...
    df.to_csv("../result/evaluation_results_new_0712.csv", index=True, float_format='%.4f')
    print(df)
